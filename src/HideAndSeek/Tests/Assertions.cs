...
internal static class Assertions
{
    ...
    /// <summary>
    /// Declares to static analyzers that a specific expression is true.
    /// </summary>
    /// <param name="condition">The expression that is expected to be true.</param>
    ...
    /// <summary>
    /// Logs an assertion failure if a specific expression is false.
    /// </summary>
    /// <param name="condition">The expression that is expected to be true.</param>
    /// <param name="message">Additional information about the assertion.</param>
    ...
    /// <returns>A string that represents how a type would be typed in source code.</returns>
